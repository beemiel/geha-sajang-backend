...
{
  "accessToken" : "eyJhbGciOiJIUzI1NiJ9.eyJhY2NvdW50IjoiZm9vIiwicm9sZSI6Im1haW4ifQ.4U2WhbbFLmBIQD3yZQ9j1EmD5AGIG6skcXykkJ_2Q7o"
}
```
...
- Response Fields
include::{snippets}/guest-controller-test/list-fail/response-fields.adoc[]
